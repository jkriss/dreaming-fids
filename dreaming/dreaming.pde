...
void draw() {
  ...
  try {
    ...
    if (frameCount % 100 == 0) 
      println("free ram: " + Runtime.getRuntime().freeMemory()/1024/1024 + "MB" + " of " + Runtime.getRuntime().totalMemory()/1024/1024 + "MB (" + Runtime.getRuntime().maxMemory()/1024/1024 + "MB max)");
